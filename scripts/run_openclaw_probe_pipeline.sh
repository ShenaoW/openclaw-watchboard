...
MAX_RECORDS="${OPENCLAW_PROBE_MAX_RECORDS:-10000}"
...
echo "[openclaw-probe] mode: fetch_only=$FETCH_ONLY cache_only=$CACHE_ONLY cache_first=$CACHE_FIRST write_live=$WRITE_LIVE refresh_db=$REFRESH_DB"
